...
- [ ] T004 Draft architecture baseline document (system design, components, data flow)
- [ ] T005 Define API contracts and interaction patterns for core flows
- [ ] T006 Document NFR targets and architecture decision rationale
...
**Constitution Gate**: Phase 2 MUST include explicit validation that architecture,
contracts, scalability/extensibility, and NFR definitions are complete and approved.

Examples of foundational tasks (adjust based on your project):

- [ ] T007 Validate architecture baseline completeness against constitution gate
- [ ] T008 [P] Validate API contracts with contract-test scaffolding
- [ ] T009 [P] Establish interaction-pattern guardrails (timeouts, retries, idempotency)
- [ ] T010 Confirm minimum scalability/extensibility posture and thresholds
...
- [ ] TXXX Validate NFR outcomes against defined acceptance checks
